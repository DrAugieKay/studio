...
export default function StepManipulationChecks({ sessionData, updateSessionData }: StepProps) {
  ...
  const handleValueChange = (values: FormValues) => {
    updateSessionData({ manipulationChecks: values });
  };
                  ...
                  <FormControl>
                    <RadioGroup 
                      onValueChange={(value) => {
                        ...
                        handleValueChange({ ...form.getValues(), feltHuman: value });
                      }} 
                ...
                <FormItem className="space-y-3 p-4 border rounded-lg bg-secondary/30">
                  ...
                  <FormControl>
                    <RadioGroup 
                      onValueChange={(value) => {
                        field.onChange(value);
                        handleValueChange({ ...form.getValues(), feltAlgorithm: value });
                      }}
                      value={field.value} className="space-y-1"
                    >
                       {likertOptions.map(option => (
                ...
                <FormItem className="space-y-3 p-4 border rounded-lg bg-secondary/30">
                  ...
                  <FormControl>
                    <RadioGroup 
                      onValueChange={(value) => {
                        field.onChange(value);
                        handleValueChange({ ...form.getValues(), sourceAttribution: value });
                      }}
                      value={field.value} className="space-y-1"
                    >
